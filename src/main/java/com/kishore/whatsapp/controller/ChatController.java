...
import com.kishore.whatsapp.request.SingleChatRequest;
import com.kishore.whatsapp.response.ApiResponse;
import com.kishore.whatsapp.service.ChatService;
import com.kishore.whatsapp.service.GroupChatRequest;
...
public class ChatController {
	...
	@PostMapping("/single")
	public ResponseEntity<Chat> createGroupHandler(@RequestBody SingleChatRequest singleChatRequest, @RequestHeader("Authorization") String jwt) throws UserException {
	...
	@PostMapping("/group")
	public ResponseEntity<Chat> createChatHandler(@RequestBody GroupChatRequest groupChatRequest, @RequestHeader("Authorization") String jwt) throws UserException {
	...
	public ResponseEntity<Chat> addUserToGroupHandler(@PathVariable("chatId") Integer chatId, @PathVariable("userId") Integer userId, @RequestHeader("Authorization") String jwt) throws UserException, ChatException {
	...
	public ResponseEntity<Chat> removeUserToGroupHandler(@PathVariable("chatId") Integer chatId, @PathVariable("userId") Integer userId, @RequestHeader("Authorization") String jwt) throws UserException, ChatException {
